import "./LPProfile.css";

function LPProfile() {
  return (
    <div className="lp-profile">
      <h2>Com quem você aprenderá:</h2>
      <img src="/images/LUD profile.jpg" alt="Ludmilla sorrindo" />
      <h2 className="purple">Psicóloga Ludmila Garcia</h2>
      <p>
      ...
      <p>
        ...
        individual e em grupo, atendimento à criança hospitalizada com câncer e
        familiares, Doenças Crônicas e transtornos alimentares, obesidade, tem
        atuação em psicologia na atenção básica da saúde.
      </p>
      <p>
        ...
        positivas na vida das pessoas, oferecendo flexibilidade, acessibilidade
        e um ambiente seguro e acolhedor para o seu desenvolvimento pessoal.
      </p>
      <p>
        Desde 2016 atuo na psicologia de forma 100% on-line, com passagens por
        Lisboa - Portugal, Luzern - Suíça, Bourdeaux - França e atualmente
        vivendo em Madrid - Espanha.
      </p>
      <p>
        Desenvolvi o Projeto “Pense Magro” em 2015 que une técnicas da Terapia
        Cognitivo Comportamental, Nutrição Comportamental e Coaching Psychology
