  ...
  return (
    <div className="marketing">
      <div className="marketing-top">
        ...
        <p>
          Sou Psicóloga desde 2008 anos e moro em Lucerna na Suíça, atendo 100%
          online e viver da psicologia é minha maior realização e felicidade,
        ...
        <div className="marketing-cronograma">
          ...
          <div className="marketing-cronograma-modulo">
            ...
            <p>Como e o que falar, como escolher temas e abordá-los </p>
            <p>Como perder o medo de gravar vídeos, stories, lives</p>
          </div>
          <div className="marketing-cronograma-modulo">
            <h3>Módulo 6</h3>
      ...
      <div className="marketing-bot">
        ...
        <div className="marketing-bot-box">
          ...
          <p>
            Ser membro do Grupo Secreto no Facebook para envio de materiais e
            trocas
          </p>
          <p>
            Acesso aos conteúdos anteriores, inclusive as aulas gravadas com
            mais de 60h Assessoria e Consultoria individual de vida e carreira
          </p>
          <p>
            Contato e acolhimento via whatsapp direto com a Mentora 7 dias por
            semana
          </p>
        </div>
